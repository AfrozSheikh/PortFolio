  ...
  const projects = [
    {
      ...
      description: 'AI-powered financial analytics platform with real-time market data visualization.',
    ...
    {
      id: 2,
      title: 'Quantum Chat Platform',
      description: 'End-to-end encrypted messaging app with quantum-resistant security protocols.',
      image: 'https://images.pexels.com/photos/8849295/pexels-photo-8849295.jpeg?auto=compress&cs=tinysrgb&w=800',
      tech: ['Next.js', 'WebRTC', 'Socket.io', 'MongoDB', 'AWS'],
      github: '#',
      live: '#',
      featured: true,
    },
    {
      ...
      description: 'Augmented reality e-commerce platform with 3D product visualization.',
      image: 'https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg?auto=compress&cs=tinysrgb&w=800',
      tech: ['React Native', 'Three.js', 'ARKit', 'Firebase', 'Stripe'],
      github: '#',
      live: '#',
      featured: false,
    },
    {
      ...
      description: 'Decentralized portfolio management with multi-chain support and DeFi integration.',
      image: 'https://images.pexels.com/photos/8369648/pexels-photo-8369648.jpeg?auto=compress&cs=tinysrgb&w=800',
      tech: ['Vue.js', 'Web3.js', 'Solidity', 'IPFS', 'MetaMask'],
      github: '#',
      live: '#',
      featured: false,
    },
